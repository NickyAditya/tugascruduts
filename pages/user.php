...
<!DOCTYPE html>
  ...
  <body class="g-sidenav-show  bg-gray-100">
              ...
              <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <div class="col-md-13 text-end me-3">
                      <a class="btn bg-gradient-dark mb-0"  data-bs-toggle="modal" data-bs-target="#tambahUserModal"><i class="material-symbols-rounded text-sm">add</i>&nbsp;&nbsp;Tambah Data user</a>
                    </div>
                  <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0">
                      <thead>
                        <tr>
                          <th class="text-center font-weight-bolder text-dark active">ID User</th>
                          <th class="text-center font-weight-bolder text-dark active">Nama</th>
                          <th class="text-center font-weight-bolder text-dark active">Username</th>
                          <th class="text-center font-weight-bolder text-dark active">Password</th>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            <td class="text-center text-sm"><?php echo $row['id_user']; ?></td>
                            <td class="text-center text-sm"><?php echo $row['nama']; ?></td>
                            <td class="text-center text-sm"><?php echo $row['username']; ?></td>
                            <td class="text-center text-sm"><?php echo $row['password']; ?></td>
                            <td class="text-center text-sm">
                              <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:void(0);" onclick="confirmDeletion('<?php echo $row['id_user']; ?>')"><i class="material-symbols-rounded text-sm me-2">delete</i>Hapus</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="updateuser.php">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editMobilLabel">Edit Data User</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label" style="color: black;">ID User</label>
          ...
          <div class="modal-content">
              <form method="POST" action="tambahuser.php">
                  ...
                  <div class="modal-body">
                      <div class="mb-3">
                          <label class="form-label" style="color: black;">ID User</label>
                          <input type="text" class="form-control" id="id_user_tambah" name="id_user" required>
                      </div>
                      <div class="mb-3">
                          <label class="form-label" style="color: black;">Nama</label>
                      ...
                      <div class="mb-3">
                          <label class="form-label" style="color: black;">Password</label>
                          <input type="text" class="form-control" id="password_tambah" name="password" required>
                      </div>
                  </div>
                  <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
    ...
    <!-- Github buttons -->
    <script>
      let deleteiduser = null; // Menyimpan plat mobil yang akan dihapus

      function confirmDeletion(id_user) {
          deleteiduser = id_user; // Set plat mobil yang akan dihapus
      ...
      document.getElementById('confirmDeleteButton').addEventListener('click', function () {
          if (deleteiduser) {
              window.location.href = "hapususer.php?id_user=" + encodeURIComponent(deleteiduser);
          }
      });
    </script>
