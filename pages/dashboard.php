<?php session_start(); 
include('koneksi.php'); // Pastikan file konfigurasi database Anda benar

// Query untuk menghitung jumlah baris pada setiap tabel
$queryMobil = "SELECT COUNT(*) as total FROM mobil";
$queryTransaksi = "SELECT COUNT(*) as total FROM transaksi";
$queryPenyewa = "SELECT COUNT(*) as total FROM penyewa";
$queryUser = "SELECT COUNT(*) as total FROM user";

// Eksekusi query
$totalMobil = mysqli_fetch_assoc(mysqli_query($koneksi, $queryMobil))['total'];
$totalTransaksi = mysqli_fetch_assoc(mysqli_query($koneksi, $queryTransaksi))['total'];
$totalPenyewa = mysqli_fetch_assoc(mysqli_query($koneksi, $queryPenyewa))['total'];
$totalUser = mysqli_fetch_assoc(mysqli_query($koneksi, $queryUser))['total'];
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-2">
      <div class="row">
        <div class="ms-3">
          <h3 class="mb-0 h4 font-weight-bolder">Halaman Utama</h3>
          <p class="mb-4">
            Selamat Datang Di Website Pengelola Rental Mobil
          </p>
        </div>
          ...
          <div class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-capitalize">Total Mobil</p>
            ...
            <div class="card-footer p-2 ps-3">
              ...
              <a href="mobil.php" class="text-info font-weight-bolder">View Details > </a></p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm">
              <a href="transaksi.php" class="text-info font-weight-bolder">View Details > </a></p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-capitalize">Total Penyewa</p>
                  <h4 class="mb-0"><?= $totalPenyewa; ?></h4>
                </div>
                <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
                  <i class="material-symbols-rounded opacity-10">Face</i>
                </div>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm">
              <a href="penyewa.php" class="text-info font-weight-bolder">View Details > </a></p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm">
              <a href="user.php" class="text-info font-weight-bolder">View Details > </a></p>
            </div>
          </div>
        </div>
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Material UI</h5>
          <p>Hanya untuk mengubah sementara</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">Warna Navbar Samping</h6>
        </div>
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">Tipe Navbar Samping</h6>
          <p class="text-sm">Pilih untuk mengubah warna navbar samping.</p>
        </div>
        <div class="d-flex">
        ...
        <p class="text-sm d-xl-none d-block mt-2">Kamu hanya bisa mengubah hanya dalam tampilan sementara.</p>
        <!-- Navbar Fixed -->
        <hr class="horizontal dark my-3">
        <div class="mt-2 d-flex">
          <h6 class="mb-0">Putih / Gelap</h6>
